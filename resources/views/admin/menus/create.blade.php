        ...
        <div class="max-w-7xl mx-auto  sm:px-6 lg:px-8">
           ...
           <div class="m-2 p-2 ">
            <div class="max-w-md mx-auto">
                ...
                action="{{ route('admin.menus.store') }}" enctype="multipart/form-data">
                ...
                @csrf
                  <div class="mb-4">
                    ...
                    <input
                      ...
                      id="post-title" type="text" placeholder="Enter Menu Name" name="name"
                    >
                    @error('name')
                  ...
                  <div class="mb-4">
                    ...
                    <input
                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('image') border-red-700 @enderror"
                  ...
                  <div class="mb-4">
                    ...
                    <input
                      ...
                      id="post-image" type="number" min="0.00" max='10000.0' step="0.01" name="price" placeholder="Enter Price"
                    >
                    @error('price')
                    <div class="text-sm text-red-700">{{ $message }}</div>
                    @enderror
                  ...
                  <div class="mb-4">
                    ...
                    <textarea
                      ...
                      id="body" placeholder="Enter Menu Description" name="description"></textarea>
                      @error('description')
                      <div class="text-sm text-red-700">{{ $message }}</div>
                      @enderror
                  </div>
