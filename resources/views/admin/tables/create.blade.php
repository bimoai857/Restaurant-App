        ...
        <div class="max-w-7xl mx-auto  sm:px-6 lg:px-8">
           ...
           <div class="m-2 p-2 ">
            <div class="max-w-md mx-auto">
                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="post" action="{{ route('admin.tables.store') }}">
                  @csrf
                  <div class="mb-4">
                    ...
                    <input
                      ...
                      id="post-title" type="text" placeholder="Enter Table Name" name="name"
                    >
                    @error('name')
                  ...
                  <div class="mb-4">
                    ...
                    <input
                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('name') border-red-700 @enderror"
                      id="post-image" type="number" name="guest_number" placeholder="Enter Table Size"
                    >
                    @error('guest_number')
                    <div class="text-sm text-red-700">{{ $message }}</div>
                    @enderror
                  ...
                  <div class="mb-4" >
                    ...
                    <select name='status'  class="form-multiselect block w-full @error('name') border-red-700 @enderror">
                  ...
                  <div class="mb-4" >
                    ...
                    <select name='location'  class="form-multiselect block w-full @error('name') border-red-700 @enderror">
